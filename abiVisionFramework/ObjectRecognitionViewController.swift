...
//  abiVisionFramework
//
//  Created by Abinesh Solairaj on 03/07/17.
...
class ObjectRecognitionViewController: CameraDetailViewController {
    ...
    func handleClassification(request: VNRequest, error: Error?) {
        ...
        // Filter observation
        let filteredOservations = observations[0...100].filter({ $0.confidence > 0.1 })
        // Update UI
